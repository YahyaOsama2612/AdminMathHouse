...
const AddSessions = () => {
  ...
  const parseHMSToDate = (timeStr) => {
    ...
    const d = new Date();
    // القيمة المخزنة (سواء جاية من الباك اند أو اتحطت لسه) بتبقى UTC دايماً،
    // فبنحطها كـ UTC هنا؛ وأي عرض للـ Date ده بتوقيت محلي (زي DatePicker)
    // هيترجمها تلقائي لتوقيت جهاز اليوزر
